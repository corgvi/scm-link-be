...
public class ProductController extends BaseController<ProductCreateRequest, ProductUpdateRequest, ProductDetailsResponse, String>{
    public ProductController(BaseService<ProductCreateRequest, ProductUpdateRequest, ProductDetailsResponse, String> baseService) {
        super(baseService);
    }
}
