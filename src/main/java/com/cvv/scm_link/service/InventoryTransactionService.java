...
public class InventoryTransactionService extends BaseServiceImpl<InventoryTransactionRequest, InventoryTransactionRequest, InventoryTransactionResponse, InventoryTransaction, String>{
    ...
    public InventoryTransactionResponse createByAdjusting(InventoryTransactionAdjustmentRequest dto) {
        InventoryLevel inventoryLevel = inventoryLevelRepository.findByWarehouse_IdAndProduct_Id(dto.getWarehouseId(), dto.getProductId()).orElseThrow(() -> new AppException(ErrorCode.INVENTORY_LEVEL_NOTFOUND));
        ...
        inventoryTransaction =  inventoryTransactionRepository.save(inventoryTransaction);
        InventoryTransactionResponse inventoryTransactionResponse = inventoryTransactionMapper.toDTO(inventoryTransaction);
