...
public class WarehouseLocationService extends BaseServiceImpl<WarehouseLocationRequest, WarehouseLocationRequest, WarehouseLocationResponse, WarehouseLocation, String> {
    WarehouseLocationRepository warehouseLocationRepository;
    WarehouseRepository warehouseRepository;
    WarehouseLocationMapper warehouseLocationMapper;

    public WarehouseLocationService(BaseRepository<WarehouseLocation, String> baseRepository, BaseMapper<WarehouseLocation, WarehouseLocationRequest, WarehouseLocationRequest, WarehouseLocationResponse> baseMapper, WarehouseLocationRepository warehouseLocationRepository, WarehouseRepository warehouseRepository, WarehouseLocationMapper warehouseLocationMapper) {
    ...
    public WarehouseLocationResponse create(WarehouseLocationRequest dto) {
        ...
        location.setWarehouse(warehouseRepository.findById(dto.getWarehouseId()).orElseThrow(() -> new AppException(ErrorCode.WAREHOUSE_NOT_FOUND)));
